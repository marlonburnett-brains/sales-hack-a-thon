...
/**
 * AtlusAI Integration Tutorial Capture
 *
 * Driven by fixtures/atlus-integration/script.json.
 */

const TUTORIAL_ID = "atlus-integration";
...
test.describe("AtlusAI Integration Tutorial Capture", () => {
