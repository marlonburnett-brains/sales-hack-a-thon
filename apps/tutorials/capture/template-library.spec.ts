...
/**
 * Template Library Tutorial Capture
 *
 * Driven by fixtures/template-library/script.json.
 */

const TUTORIAL_ID = "template-library";
...
test.describe("Template Library Tutorial Capture", () => {
