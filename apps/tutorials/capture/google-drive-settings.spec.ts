...
/**
 * Google Drive Settings Tutorial Capture
 *
 * This spec is driven by the tutorial script JSON at
 * fixtures/google-drive-settings/script.json. The capture loop is generic --
...
test.describe("Google Drive Settings Tutorial Capture", () => {
