...
/**
 * Touch 2 Intro Deck Tutorial Capture
 *
 * Captures the complete Touch 2 Intro Deck human-in-the-loop workflow.
 * 13 steps covering: idle -> generating -> skeleton -> skeleton-refining ->
 * skeleton-refined -> lowfi -> hifi -> completed
 */

const TUTORIAL_ID = "touch-2-intro-deck";
...
test.describe("Touch 2 Intro Deck Tutorial Capture", () => {
