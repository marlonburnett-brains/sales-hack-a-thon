...
/**
 * Touch 1 Pager Tutorial Capture
 *
 * Captures the complete Touch 1 First-Contact Pager human-in-the-loop workflow.
 * 15 steps covering: idle -> generating -> skeleton -> lowfi -> lowfi-refining ->
 * lowfi-refined -> hifi -> completed -> manual-upload
 */

const TUTORIAL_ID = "touch-1-pager";
...
test.describe("Touch 1 Pager Tutorial Capture", () => {
