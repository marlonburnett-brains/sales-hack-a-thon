...
/**
 * Touch 4 HITL Tutorial Capture
 *
 * Captures the complete Touch 4 Sales Proposal human-in-the-loop workflow.
 * This spec exercises the full Phase 63 infrastructure: stage control endpoints,
 * stage-aware fixture loading, sequence counters for polling, and waitForText-based
 * screenshot timing.
 *
 * 6 steps covering: idle -> generating -> skeleton -> lowfi -> hifi -> completed
 */

const TUTORIAL_ID = "touch-4-hitl";
...
test.describe("Touch 4 HITL Tutorial Capture", () => {
