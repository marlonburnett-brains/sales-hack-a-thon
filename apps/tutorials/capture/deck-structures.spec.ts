...
/**
 * Deck Structures Tutorial Capture
 *
 * Driven by fixtures/deck-structures/script.json.
 */

const TUTORIAL_ID = "deck-structures";
...
test.describe("Deck Structures Tutorial Capture", () => {
