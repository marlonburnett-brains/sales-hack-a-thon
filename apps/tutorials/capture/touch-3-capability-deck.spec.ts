...
/**
 * Touch 3 Capability Deck Tutorial Capture
 *
 * Captures the complete Touch 3 Capability Deck human-in-the-loop workflow.
 * 13 steps covering: idle -> generating -> skeleton -> lowfi -> lowfi-refining ->
 * lowfi-refined -> hifi -> completed
 */

const TUTORIAL_ID = "touch-3-capability-deck";
...
test.describe("Touch 3 Capability Deck Tutorial Capture", () => {
